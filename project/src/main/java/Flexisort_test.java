...
class FlexisortTest {
    ...
    void performanceTest_shouldCompareAlgorithmsInDifferentConditions() {
        ...
        // Test BubbleSort.java on random array
        Sorter bubbleSorter = new BubbleSort();
        ...
        // Test BubbleSort.java on sorted array
        ...
        // Test BubbleSort.java on reverse sorted array
        ...
        System.out.println("BubbleSort.java time on random array (ns): " + bubbleSortRandomTime);
        System.out.println("InsertionSort time on random array (ns): " + insertionSortRandomTime);
        System.out.println("BubbleSort.java time on sorted array (ns): " + bubbleSortSortedTime);
        System.out.println("InsertionSort time on sorted array (ns): " + insertionSortSortedTime);
        System.out.println("BubbleSort.java time on reverse sorted array (ns): " + bubbleSortReverseSortedTime);
